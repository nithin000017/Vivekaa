...
public partial class WebPages_Achievements : System.Web.UI.Page
{
    ...
    private void GetRegDetails(int Mid)
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            txtstdName.Text = ds.Tables[0].Rows[0]["Reg_Name"].ToString();
            txtstdRegNo.Text = ds.Tables[0].Rows[0]["Reg_RegNo"].ToString();
    ...
    protected void btnRegSubmit_Click(object sender, EventArgs e)
    {
       try
         {
             string RegDepartment = ddlDepartment.Text;
           ...
           string Contact = TxtRegContact.Text;
             ...
             {
                 string qry = "Insert into tbl_Registration(Reg_RegNo,Reg_Name,Reg_Contact,Reg_Department,Reg_Class,Reg_Role,Reg_Password,Reg_Email)values('" + RegNo + "','" + RegName + "','" + Contact + "','" + RegDepartment + "','" + RegClass + "','" + RegRole + "', '" +RegPassword+"','"+RegEmail+"')";
                 objsql.Open();
                 SqlCommand cmd = new SqlCommand(qry, objsql);
                 int res = cmd.ExecuteNonQuery();
                 objsql.Close();
        ...
        if (DdlRegDepartment.SelectedValue == "Mechanical")
        {
            ...
            if (ds != null)
            {
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    TxtRegNo.Text = "VCP_MC" + num1;
                }
                else
                {
                    TxtRegNo.Text = "VCP_MC001";
                }
            }
        }
        else if (DdlRegDepartment.SelectedValue == "Computer Science")
        {
            ...
            if (ds1 != null)
            {
                if (ds1.Tables[0].Rows.Count > 0)
                {
                    ...
                    TxtRegNo.Text = "VCP_CS" + num1;
                }
                else
                {
                    TxtRegNo.Text = "VCP_CS001";
                }
            }
        }
        else if (DdlRegDepartment.SelectedValue == "Civil")
        {
            ...
            if (ds2 != null)
            {
                if (ds2.Tables[0].Rows.Count > 0)
                {
                    ...
                    TxtRegNo.Text = "VCP_CV" + num1;
                }
                else
                {
                    TxtRegNo.Text = "VCP_CV001";
                }
            }
        }
        else if (DdlRegDepartment.SelectedValue == "Electrical")
        {
            ...
            if (ds3 != null)
            {
                if (ds3.Tables[0].Rows.Count > 0)
                {
                    ...
                    TxtRegNo.Text = "VCP_EC" + num1;
                }
                else
                {
                    TxtRegNo.Text = "VCP_EC001";
                }
            }
        }
        else
        {
            ...
            if (ds4 != null)
            {
                if (ds4.Tables[0].Rows.Count > 0)
                {
                    ...
                    TxtRegNo.Text = "VCP_AM" + num1;
                }
                else
                {
                    TxtRegNo.Text = "VCP_AM001";
                }
