...
<asp:Content ID="Content3" ContentPlaceHolderID="Body" runat="Server">
    ...
    <div class="container">
        ...
        <div class="row" runat="server" visible="false" id="divAddStudent">
            <div class="col-md-12" style="border: 3px solid #565029; border-width: initial; border-radius: 12px; padding: 20px; background-color: #ffffff3b; box-shadow: -16px 15px 19px -6px rgb(0 0 0 / 18%)">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 ">
                        <asp:Button ID="btnRegViewStud" CausesValidation="false" runat="server" Text="BACK" OnClick="btnRegViewStud_Click" CssClass="btn-primary" />
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 aligntext1">
                        <asp:DropDownList ID="DdlRegDepartment" runat="server" OnSelectedIndexChanged="DdlRegDepartment_SelectedIndexChanged" AutoPostBack="true" Width="81%" Height="27px">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:Button ID="btnRegSubmit" runat="server" Text="SAVE"  OnClick="btnRegSubmit_Click" CssClass="btn-primary" />
                        &nbsp
                        <asp:Button ID="btnRegReset" runat="server" Text="RESET"  OnClick="btnRegReset_Click" CausesValidation="false" CssClass="btn-primary" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row" runat="server" visible="false" id="divAchievement">
            ...
            <div class="col-md-12" style="border: 3px solid #565029; border-width: initial; border-radius: 12px; padding: 20px; background-color: #ffffff3b; box-shadow: -16px 15px 19px -6px rgb(0 0 0 / 18%)">
                ...
                <div class="row">
                    <div class="col-md-8"></div>
                    <div class="col-md-2 ">
                        <asp:Button ID="btnview" CausesValidation="false" runat="server" Text="BACK" OnClick="btnview_Click" CssClass="btn-primary" />
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 aligntext1">
                        <asp:DropDownList ID="ddlDepartment" runat="server" Width="145px" Height="32px">
                            <asp:ListItem>--Select--</asp:ListItem>
                            <asp:ListItem>Mechanical</asp:ListItem>
                            <asp:ListItem>Computer Science</asp:ListItem>
                            <asp:ListItem>Civil</asp:ListItem>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <asp:Button ID="btnsave" runat="server" Text="Submit" Width="50%" OnClick="btnsave_Click" CausesValidation="false" CssClass="btn-primary" />

                    </div>
                    <div class="col-md-2">
                        <asp:Button ID="btncancel" runat="server" Text="Cancel" Width="50%" OnClick="btncancel_Click" CausesValidation="false" CssClass="btn-primary" />
                    </div>
            ...
            <div class="col-md-12" style="border: 3px solid #565029; border-width: initial; border-radius: 12px; padding: 20px; background-color: #ffffff3b; box-shadow: -16px 15px 19px -6px rgb(0 0 0 / 18%)">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 aligntext1">
                        ...
                        <asp:Button ID="btnStdMAster" CausesValidation="false" runat="server" Text="ADD STUDENT" OnClick="btnStdMAster_Click" CssClass="btn-primary" />
                    </div>
                    <div class="col-md-5 aligntext">

                        <asp:Button ID="btnadd" CausesValidation="false" runat="server" Text="VIEW ACHIEVEMENTS" OnClick="btnadd_Click" CssClass="btn-primary" />
                    </div>
                    <div class="col-md-1"></div>
                </div>
                <br />
                ...
                <div class="container" style="padding: 10px; width: 1000px; background-color: #fff0d1; box-shadow: 0px 0px 6px 0px rgb(0 0 0 / 18%)">
                    <div style="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 aligntext1">
                                <asp:DropDownList ID="DdlsDepartment" runat="server" Width="81%" Height="27px">
                                    <asp:ListItem>--Select--</asp:ListItem>
                                    <asp:ListItem>Mechanical</asp:ListItem>
                                    <asp:ListItem>Computer Science</asp:ListItem>
                                    <asp:ListItem>Civil</asp:ListItem>
                        ...
                        <div class="row">
                            <div class="col-md-4"></div>
                            <div class="col-md-4 ">
                                <asp:Button ID="btnsearch" runat="server" Text="SEARCH" OnClick="btnsearch_Click" CausesValidation="false" CssClass="btn-primary" />

                                &nbsp;
                        <asp:Button ID="btnrefresh" runat="server" Text="REFRESH" OnClick="btnrefresh_Click" CausesValidation="false" CssClass="btn-primary" />
                            </div>
        ...
        <div class="row" runat="server" visible="false" id="divAchieventsGrid">
            <div class="col-md-12" style="border: 3px solid #565029; border-width: initial; border-radius: 12px; padding: 20px; background-color: #ffffff3b; box-shadow: -16px 15px 19px -6px rgb(0 0 0 / 18%)">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 aligntext">
                        <asp:Button ID="btnStdBAck" CausesValidation="false" runat="server" Text="BACK" OnClick="btnStdBAck_Click" CssClass="btn-primary" />
                    </div>
                </div>
                <br />
                <br />
                ...
                <div class="container" style="padding: 10px; width: 1000px; background-color: #fff0d1; box-shadow: 0px 0px 6px 0px rgb(0 0 0 / 18%)">
                    <div style="">
                        ...
                        <div class="row">
                            <div class="col-md-4"></div>
                            <div class="col-md-4 ">
                                <asp:Button ID="Button1" runat="server" Text="SEARCH" OnClick="btnsearch_Click" CausesValidation="false" CssClass="btn-primary" />

                                &nbsp;
                        <asp:Button ID="Button2" runat="server" Text="REFRESH" OnClick="btnrefresh_Click" CausesValidation="false" CssClass="btn-primary" />
                            </div>
